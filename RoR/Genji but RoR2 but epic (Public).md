...
## Model
 ...
 ![failed to load image](<_Public/img/Attachment 1.png>)

- Stlll needs a weapon
- Possible Color reference
- ![ok not final](<_Public/img/Attachment 2.png>)![i could live with it just kinda ugly](<Game/img/Attachment 3.png>)
